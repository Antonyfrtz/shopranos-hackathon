const filterlistcustom_filterlist = {
    props: {
        model: Object
    },
    data() {
        ...
        setActiveFilters() {
            if (this.filterData !== null && this.filterData.filters !== null && this.filterData !== undefined && this.filterData.filters !== undefined) {
                ...
                if (this.filtersPosition === 0) {
                    ...
                    if (
                        (isRetailPriceFilterMatched === undefined || isRetailPriceFilterMatched.length === 0) && 
...
app.component('filterlistcustom_filterlist', {
    extends: filterlistcustom_filterlist,
    template: '#filterlistcustom_filterlist'
});
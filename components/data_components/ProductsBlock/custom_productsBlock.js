const productsblockcustom_productsblock = {
    props: {
        model: Object
    },
    data() {
...
app.component('productsblockcustom_productsblock', {
    extends: productsblockcustom_productsblock,
    template: '#productsblockcustom_productsblock'
});